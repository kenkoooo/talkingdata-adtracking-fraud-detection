...
# 一時テーブルに展開
\copy t from '/home/ubuntu/talkingdata-adtracking-fraud-detection/data/tarin.csv' DELIMITER ',' CSV HEADER;

# 一時テーブルからコピー
INSERT INTO click_data (ip,app,device,os,channel,click_time,attributed_time,is_attributed)
       SELECT click_id,ip,app,device,os,channel,click_time,attributed_time,is_attributed FROM t;
